...
**Important**: After collecting parameters, start Steps 2 through 10 in serial for comprehensive analysis.
...
Identify regions with CRITICAL or WARNING status. Proceed to Step 5.
...
Identify partitions with poor health scores and high severity. Proceed to Step 6.
...
Zones with CRITICAL or DEGRADED status need immediate attention. Proceed to Step 7.
...
Identify endpoints with HIGH_SERVER_ERRORS or LOW_SUCCESS_RATE. Proceed to Step 8.
...
Products with SLA_BREACH status require immediate action. Proceed to Step 9.
...
Consolidate findings from all analyses and create an action plan.
